    ...
    <div className='fixed inset-0 -z-10 overflow-hidden'>
      ...
      <div className='absolute inset-0 bg-gradient-to-br from-neutral-900 via-black to-neutral-800'>
        ...
        <div className='absolute top-0 left-0 h-full w-full'>
          ...
          <div className='absolute top-10 left-20 h-28 w-80 rotate-6 transform bg-gradient-to-br from-neutral-700 to-neutral-800 shadow-md'></div>
          ...
          <div className='absolute right-40 bottom-5 h-32 w-72 -rotate-6 transform bg-gradient-to-tl from-neutral-800 to-neutral-900 shadow-lg'></div>

          {/* Side accent shapes with neutral tones */}
          <div className='absolute top-1/4 right-0 h-48 w-64 translate-x-32 rotate-45 transform bg-gradient-to-l from-neutral-800 to-transparent'></div>
          <div className='absolute bottom-1/4 left-0 h-48 w-64 -translate-x-32 -rotate-45 transform bg-gradient-to-r from-neutral-800 to-transparent'></div>
        </div>
      </div>
