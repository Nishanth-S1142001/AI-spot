...
const StatCard = memo(({ 
  ...
  <Card className={`group border-${colorClass}-600/20 bg-gradient-to-br from-${colorClass}-950/20 to-neutral-950/50 transition-all hover:scale-[1.02] hover:shadow-lg`}>
    <div className='flex items-center justify-between'>
      <div className='flex-1'>
        ...
        {trend && trendValue && (
          <div className='mt-2 flex items-center gap-1 text-xs'>
            <ArrowUp className={`h-3 w-3 ${trend === 'up' ? 'text-green-400' : 'rotate-180 text-red-400'}`} />
      ...
      <div className={`flex h-12 w-12 items-center justify-center rounded-full bg-${colorClass}-900/40 transition-transform group-hover:scale-110`}>
          ...
          <div className='space-y-4'>
            ...
            <div className='grid gap-4 sm:grid-cols-3'>
              ...
              <div className='rounded-lg border border-neutral-800/50 bg-neutral-900/30 p-4'>
                ...
                <p className='mt-1 text-xl font-bold text-neutral-200'>
                  {stats.uniqueUsers > 0
                    ? Math.round(stats.totalConversations / new Set(conversations.map(c => c.session_id)).size)
                    : 0} msgs
                </p>
              </div>
              ...
              <div className='rounded-lg border border-neutral-800/50 bg-neutral-900/30 p-4'>
                ...
                <p className='mt-1 text-xl font-bold text-neutral-200'>
                  {stats.uniqueUsers > 0
                    ? ((stats.totalConversations / stats.uniqueUsers) * 10).toFixed(1)
                    : 0}%
                </p>
              </div>
            </div>
