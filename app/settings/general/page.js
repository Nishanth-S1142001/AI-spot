    ...
    <div>
      ...
      <div className='flex items-center gap-6'>
        <div className='relative'>
          <div className='h-20 w-20 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-2xl font-bold text-white'>
            {fullName?.[0]?.toUpperCase() || 'U'}
          </div>
          <label
            htmlFor='avatar-upload'
            className='absolute bottom-0 right-0 rounded-full bg-orange-600 p-2 text-white hover:bg-orange-700 transition-colors cursor-pointer'
          >
...
const PasswordInput = memo(({ 
  ...
  return (
    <div>
      ...
      <div className='relative'>
        <Icon className='absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-neutral-500' />
        <input
          type={showPassword ? 'text' : 'password'}
          value={value}
          onChange={onChange}
          className='w-full rounded-lg bg-neutral-900 border border-neutral-800 pl-10 pr-12 py-2 text-neutral-100 placeholder:text-neutral-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20'
      ...
      <form onSubmit={onSubmit} className='space-y-6'>
        ...
        <div>
          ...
          <input
            ...
            className='w-full rounded-lg bg-neutral-900 border border-neutral-800 px-4 py-2 text-neutral-100 placeholder:text-neutral-500 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20'
        ...
        <div>
          ...
          <div className='relative'>
            ...
            <input
              ...
              disabled
              className='w-full rounded-lg bg-neutral-900/50 border border-neutral-800 pl-10 pr-4 py-2 text-neutral-400 cursor-not-allowed'
            />
          </div>
...
export default function GeneralSettingsPage() {
  ...
  const { mutate: updateNotificationPrefs, isPending: notificationLoading } = useUpdateNotifications()
